# -*- coding: utf-8 -*-
"""Robo Defensivo.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14pvyxdMXl_P2TyHA7klWtGg5-0oyW-TR
...
token = '5984718032:AAE5H1lAmv_BkjUuVM_Pw-_pKY98xehXvUM'
chat_id = '-1001577202346'
...
while True:
  try:
    ...
    for game in dic_response['data']:
      ...
      text = ''
      if mh1_home + mh1_away > 0 and mh2_home + mh2_away == 2 and exg_home + exg_away == 0 and appm2_home + appm2_away == 0:
