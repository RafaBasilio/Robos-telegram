# -*- coding: utf-8 -*-
"""Robo Over Telegram v2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vXauC-0KfwC-KlUDFQn4wg46lRe0Sfnh
...
token = '6127910588:AAFi9ZsJtrL16zXEdBjo0bl6Wy1Uj2UZfoI'
chat_id = '-1001898489732'
...
while True:
  try:
    ...
    for game in dic_response['data']:
      ...
      text = ''
      if mh2_home + mh2_away >= 18 and exg_home + exg_away == 4 and appm2_home + appm2_away >= 2:
