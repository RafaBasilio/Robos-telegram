# -*- coding: utf-8 -*-
"""Robô Próximo Golo Telegramipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16ai6F39fu5INzemdXL0COFEBnrVoR8hy
...
token = '5907686389:AAHFkFRSTp3sa8ML2ciU_l5GM3xJpQBjcxg'
chat_id = '-1001811338963'
...
while True:
  try:
    ...
    for game in dic_response['data']:
      ...
      text = ''
      if (mh2_home >= 15 and mh2_away <= 2 and exg_home == 2 and exg_away <= 0.2 and appm2_home >= 1.5 and appm2_away <= 0.2) or (mh2_home <=2 and mh2_away >= 15 and exg_home <= 0.2 and exg_away == 2 and appm2_home <= 0.2 and appm2_away >= 1.5):
